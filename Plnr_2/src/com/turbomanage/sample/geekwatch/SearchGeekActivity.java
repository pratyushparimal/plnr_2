...
public class SearchGeekActivity extends CloudBackendActivity implements
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.layout_geek_search);
        ...
        private void setListAdapter()
        {
    		...
    		aa = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, usersList);
    		usersListView.setAdapter(aa);
...
//			return interest;
		...
		@Override
		public void setSelectedScreen(String interest) {
//			mInterest = interest;
//	        SharedPreferences.Editor ed = getPreferences(MODE_PRIVATE).edit();
//	        ed.putString(SearchGeekActivity.KEY_INTEREST, interest);
//	        ed.commit();
//			if (mSelf != null) {
//				mSelf.setInterest(mInterest);
//				getCloudBackend().update(mSelf.asEntity(), updateHandler);
//			}
			GeekwatchActivity.global_selected = interest;
		}
